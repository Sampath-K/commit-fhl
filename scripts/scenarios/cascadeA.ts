...
export const CASCADE_A_COMMITMENTS: Omit<CommitmentRecord, 'agentDraft'>[] = [
  {
    id:    CASCADE_A_COMMITMENT_IDS.apiDesign,
    ...
    dueAt:       '2026-03-03T17:00:00Z', // Was due Monday, now Wednesday — at risk
    status:      'pending',
    ...
    lastActivity:        '2026-02-28T15:00:00Z', // No activity in 2 days — at risk
  },
  {
    id:    CASCADE_A_COMMITMENT_IDS.designUpdates,
    ...
    committedAt: '2026-02-28T11:00:00Z',
    dueAt:       '2026-03-04T17:00:00Z',
    status:      'pending',
    priority:    'urgent-important',
  ...
  {
    id:    CASCADE_A_COMMITMENT_IDS.featureShip,
    ...
    committedAt: '2026-02-27T14:00:00Z',
